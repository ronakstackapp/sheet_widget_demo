...
import 'package:sheet_widget_demo/payment_gateway/store.dart';
...
class PaymentHomeApp extends StatefulWidget {
  @override
  PaymentHomeAppState createState() => PaymentHomeAppState();
}

class PaymentHomeAppState extends State<PaymentHomeApp> {
      ...
      stack.add(
        Stack(
          children: [
            Opacity(
              opacity: 0.3,
              child: const ModalBarrier(dismissible: false, color: grey),
            ),
            Center(
  ...
  Card _buildConnectionCheckTile() {
    ...
    final Widget storeHeader = ListTile(
      leading: Icon(_isAvailable ? Icons.check : Icons.block,
          color: _isAvailable ? themeColor : ThemeData.light().errorColor),
  ...
  Card _buildProductList() {
    if (_loading) {
      return Card(
          child: (ListTile(
              leading: CircularProgressIndicator(), title: Text('Fetching products...'))));
    }
    if (!_isAvailable) {
      return Card();
    }
      ...
      (ProductDetails productDetails) {
        ...
        return ListTile(
            ...
            trailing: previousPurchase != null
                ? IconButton(
                    onPressed: () => confirmPriceChange(context), icon: Icon(Icons.upgrade))
                : TextButton(
  ...
  Card _buildConsumableBox() {
    if (_loading) {
      return Card(
          child: (ListTile(
              leading: CircularProgressIndicator(), title: Text('Fetching consumables...'))));
    }
